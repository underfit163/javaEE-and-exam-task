        ...
        <div class="form-popup" id="myForm">
            <form action="composition" name="addForm" class="form-container" method="post"
                ...
                <label>
                    ...
                    <input type="text" name="name" placeholder="Введите название" title="Введите название" list="nameDL"
        ...
        <tr id="tr${composition.idComposition}">
            <form id="${composition.idComposition}" name="udForm" action="composition" method="POST"
                ...
                <td><input type="text" name="name" value="${composition.nameComposition}"
                           title="${composition.nameComposition}" form="${composition.idComposition}" list="nameDL"
                           autocomplete="off"></td>
                ...
                <td>
                    <button id="uB${composition.idComposition}" type="submit" name="action" value="edit"
                            class="shine-button" form="${composition.idComposition}"><i>Обновить</i>
                    </button>
                </td>
                <td>
                    <button id="uB${composition.idComposition}" type="submit" name="action" value="delete"
                            class="shine-button" form="${composition.idComposition}"><i>Удалить</i></button>
                </td>
            </form>
        </tr>
    </c:forEach>
